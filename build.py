...
<div class="laptop" role="img" aria-label="SDS workspaces cycling on a MacBook"><div class="lid"><div class="screen"><img src="assets/img/sds/workspaces/drivers.jpg" alt="SDS Drivers workspace"><img src="assets/img/sds/workspaces/crossover.jpg" alt="SDS Crossover workspace" loading="lazy"><img src="assets/img/sds/workspaces/enclosure.jpg" alt="SDS Enclosure workspace" loading="lazy"><img src="assets/img/sds/workspaces/workshop.jpg" alt="SDS Workshop workspace" loading="lazy"><img src="assets/img/sds/workspaces/workshop-scene.jpg" alt="SDS Workshop scene render workspace" loading="lazy"><img src="assets/img/sds/workspaces/simulate.jpg" alt="SDS Simulate workspace" loading="lazy"><img src="assets/img/sds/workspaces/measure.jpg" alt="SDS Measure workspace" loading="lazy"><img src="assets/img/sds/workspaces/measure-room.jpg" alt="SDS Measure room setup workspace" loading="lazy"></div></div><div class="base"><span></span></div></div></div></section>
...
stack();var busy=false,visible=true;
function next(){{if(busy||!visible)return;busy=true;var top=order[0];top.classList.add('out');
setTimeout(function(){{top.classList.add('reset');top.classList.remove('out');order.push(order.shift());stack();
